...
>
	...
	<ul class="font-stylish text-4xl" on:mousemove={handleMousemove}>
		<li
			data-aos="fade-up"
			class="group mt-20 hlink grid grid-cols-2"
			on:mouseenter={() => (visible1 = true)}
			on:mouseleave={() => (visible1 = false)}
		...
		>
			...
			{#if visible1 && !section1}
				...
				<img
					src="../Assets/photos/project1.jpg"
					alt="project-1"
					class="w-[275px] image rounded-lg"
		...
		{#if section1}
			<div
				class="grid grid-cols-1 justify-items-center animate__animated animate__fadeIn"
				in:slide
				out:slide={{ delay: 600, duration: 700 }}
			>
				<Section1 />
				<a
					href="#section-1"
					on:click|preventDefault={scrollIntoView}
					on:click={() => (section1 = false)}
					class="bg-blue-200 dark:bg-rose-400 justify-self-end rounded-full p-2 cursor-none hlink text-black hover:text-white transition ease-in-out duration-300"
					>Hide</a
				>
			</div>
		{/if}
		...
		<li
			data-aos="fade-up"
			class="group mt-20 hlink grid grid-cols-2"
			on:mouseenter={() => (visible2 = true)}
			on:mouseleave={() => (visible2 = false)}
			on:click={handleClick2}
		>
			<h1 id="section-2" class="group-hover:text-gray-500 transition ease-in-out duration-300 z-10">
				Java Banking App
			</h1>
			{#if visible2 && !section2}
				<p class="justify-self-end z-10" transition:fade>View</p>
				<img
					src="../Assets/photos/project2.jpg"
					alt="project-1"
					class="w-[275px] image rounded-lg"
					style="top: {top}px; left: {left}px;"
					transition:fade={{ delay: 150 }}
		...
		<li
			data-aos="fade-up"
			class="group mt-20 hlink grid grid-cols-2"
			on:mouseenter={() => (visible4 = true)}
			on:mouseleave={() => (visible4 = false)}
		...
		>
			...
			{#if visible4 && !section4}
				<p class="justify-self-end z-10" transition:fade>View</p>
				<img
					src="../Assets/photos/project4.jpg"
					alt="project-1"
					class="w-[275px] image rounded-lg"
					style="top: {top}px; left: {left}px;"
					transition:fade={{ delay: 150 }}
