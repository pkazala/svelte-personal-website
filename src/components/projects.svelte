<div class="h-fit my-4 text-center max-w-7xl m-auto divide-y mt-16">
	...
	<div class="grid mine:grid-cols-2 grid-cols-1 my-5 p-3 items-center">
		<div class="grid grid-cols-1 sm:p-3 sm:pr-5">
			<h1 data-aos="fade-up" data-aos-easing="ease-in-out" class="text-4xl font-mono font-bold text-gray-600 dark:text-gray-100">E-Commerce website</h1>
			<div data-aos="fade-up" data-aos-delay=300 class="text-2xl mt-4 text-gray-500 dark:text-gray-300 text-left">
	...
	<div class="grid mine:grid-cols-2 grid-cols-1 my-5 p-3 items-center mt-16 pt-16">
		...
		<div class="grid grid-cols-1 sm:p-3 sm:pr-5">
			<h1 data-aos="fade-up" data-aos-easing="ease-in-out" class="text-4xl font-mono font-bold text-gray-600 dark:text-gray-100">Bank Application</h1>
			<div data-aos="fade-up" data-aos-delay=300 class="mine:pl-5 text-2xl mt-4 text-gray-600 dark:text-gray-300 text-left">
